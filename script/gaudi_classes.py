...
# Copy of Seq2SeqTrainer but now under the GaudiTrainer class.
class Seq2SeqGaudiTrainer(GaudiTrainer):
...
# Copy of Seq2SeqTrainingArguments but now under the GaudiTrainingArguments class.
class Seq2SeqGaudiTrainingArguments(GaudiTrainingArguments):
    """
